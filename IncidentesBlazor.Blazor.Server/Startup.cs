...
using IncidentesBlazor.Blazor.Server.Services;
...
namespace IncidentesBlazor.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<IncidentesBlazorBlazorApplication>(Configuration);
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(IncidentesBlazor.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // Comment out the following line if using PermissionPolicyUser or a custom user type.
                options.UserLoginInfoType = typeof(IncidentesBlazor.Module.BusinessObjects.ApplicationUserLoginInfo);
