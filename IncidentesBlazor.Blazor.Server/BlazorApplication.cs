...
namespace IncidentesBlazor.Blazor.Server {
    public partial class IncidentesBlazorBlazorApplication : BlazorApplication {
        public IncidentesBlazorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void IncidentesBlazorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
